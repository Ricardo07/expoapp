...
<div class="demo">
    Slick &amp; Clean
    <h1>&#x25C2; CSS3 EXTENDED QUESTIONNAIRE FORM &#x25B8;</h1>
</div>
<!-- End demo page title -->
...
<!-- Questionnaire form -->
<form id="questionnaire-form" class="forms" method="post" name="questionnaire-form" autocomplete="on" action="">
<!-- Questionnaire Tab 1 -->
<div class="qf-1">
    <!-- Page no. info -->
    <span class="pagination">Page 1 of 3</span>
    <!-- Title -->
    <div class="title"><span>Step 1:</span>All about you</div>
    <!-- Intro text -->
    ...
    <!-- Left block -->
    <div class="w-47 mr-6">
        <div class="clrfx mt-10 mb-30 bt"><span class="inner-title">Basic info</span></div>
        <!-- Name input -->
        <div class="field">
            <input name="name" placeholder="Contact name" type="text" id="name" required />
            <span class="entypo-user icon"></span>
            <span class="slick-tip left">Contact name</span>
        </div>
        <!-- Company name input -->
        <div class="field">
        ...
        <div class="field">
            ...
            <span class="slick-tip left">Company address</span>
        </div>
        <!-- Industry input -->
        <div class="field">
        ...
        <div class="field">
            ...
            <span class="slick-tip left">Contact email</span>
        </div>
        <!-- Phone input -->
        <div class="field">
        ...
        <div class="field">
            ...
            <span class="slick-tip left">Corporate website</span>
        </div>
    </div>
    <!-- Right block -->
    <div class="w-47">
        <div class="clrfx mt-10 mb-30 bt"><span class="inner-title">Detailed info</span></div>
        <!-- Tick checboxes 1 -->
        <div class="field">
